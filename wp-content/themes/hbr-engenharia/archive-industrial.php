...
<div class="main p-projetos">
    ...
    <?php 
        ...
        $industrial = new WP_Query( $args );

        if ( $industrial->have_posts() ) :
    ?>
    <div class="content-center">
        <div class="buttons-cat flex">
            <a href="../industrial/" class="c-button active">Industrial</a>
        ...
        <div class="flex-cards">
            <?php while ($industrial->have_posts() ) : $industrial->the_post();
                $imgIndustrial = get_field('imagem_industrial');
                $textIndustrial = get_field('texto_thumb');
            ?>
            <a href="<?php the_permalink();?>" class="item-card">
                <figure>
                    <img src="<?php echo $imgIndustrial;?>" alt="">
                </figure>
                <div class="info">
                    <h3><?php the_title();?></h3>
                    <div class="list-info">
                        <div class="item-info">
                            <p><?php echo $textIndustrial;?></p>
                        </div>
                        <?php 
                            $localInd = get_field('local_projeto');
                            if ($localInd):
                        ?>
                        <div class="item-info">
                            <img src="<?php echo TEMPLATE; ?>dist/images/icon-local-g.svg" alt="">
                            <p><?php echo $localInd; ?></p>
                        </div>
                        <?php endif; ?>
                    </div>
                </div>
    ...
    <?php endif; ?> 
    <?php wp_pagenavi( array( 'query' => $industrial )); ?>
