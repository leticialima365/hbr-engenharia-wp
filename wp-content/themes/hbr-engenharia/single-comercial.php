...
<div class="main p-projetos-interna">
		...
		<div class="content-center">
            <div class="flex">
                ...
                <div class="text">
                    ...
                    <h3 class="subtitle-box">Projetos - Comercial</h3>
                </div>
            </div>
		</div>
    </div>
    ...
    <div class="content-interna">
        <div class="content-center">
            <figure class="img-projeto">
                <img src="<?php echo get_field('imagem_comercial');?>" alt="">
            </figure>
            <div class="list-info">
                <?php 
            ...
            <div class="text">  
            <?php echo get_field('texto_comercial');?>
                <!-- <h3>Sobre</h3>
    ...
    <?php if( have_rows('galeria_de_imagens_comercial') ): ?>
    <div class="galeria-part">
        ...
        <div class="position-slide">
            ...
            <?php while( have_rows('galeria_de_imagens_comercial') ): the_row(); 
